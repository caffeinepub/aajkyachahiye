...
import type { Demand as _Demand } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async getDemand(arg0: bigint): Promise<Demand> {
        if (this.processError) {
            try {
                const result = await this.actor.getDemand(arg0);
                return from_candid_Demand_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
    ...
    async getDemands(): Promise<Array<Demand>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDemands();
    ...
    async postDemand(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string | null, arg6: boolean): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.postDemand(arg0, arg1, arg2, arg3, arg4, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg5), arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerProvider(arg0: string, arg1: string, arg2: string, arg3: Array<string>, arg4: string, arg5: boolean): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.registerProvider(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Demand_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Demand): Demand {
...
function from_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        phone: value.phone,
        budget: record_opt_to_undefined(from_candid_opt_n3(_uploadFile, _downloadFile, value.budget)),
        location: value.location
    };
}
function from_candid_vec_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Demand>): Array<Demand> {
    return value.map((x)=>from_candid_Demand_n1(_uploadFile, _downloadFile, x));
}
